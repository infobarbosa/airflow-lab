...
aws ec2 authorize-security-group-ingress --group-id $CLOUD9_EC2_SECURITY_GROUP_ID --protocol tcp --port 8080 --cidr 0.0.0.0/0

echo "### Regra de acesso público incluída com sucesso! ###"

echo "Configurações aplicadas com sucesso!"
echo "Acesse o ambiente Cloud9 em: http://$CLOUD9_EC2_PUBLIC_DNS:8080"
